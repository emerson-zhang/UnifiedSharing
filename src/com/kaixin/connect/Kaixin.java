...
public class Kaixin {
	 ...
	 */
	public static final String API_KEY = "704611379094b5088ae4867b9e904ff4"; // 替换为申请时获得的api key
	
	/**
	 * 组件申请时获得的secret key
	 */
	public static final String SECRET_KEY = "7629d0adf0aef8cd89039f73c99efd0e"; // 替换为申请时获得的secret key
